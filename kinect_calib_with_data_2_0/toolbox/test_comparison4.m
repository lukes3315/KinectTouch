%%
calib_data = load('C:\datasets\kinect_toolbox\calibA1\best_calib.mat');
reg_data = read_yaml('C:\datasets\kinect_toolbox\calibA1\registration.yml');
calib = calib_data.final_calib;
base_path = 'C:\datasets\kinect_toolbox\cube_comparison\';
filename = [base_path 'raw\0000-d.pgm'];
width = 640;
height = 480;
...
[points,disparity]=get_depth_samples({filename, filename, filename},mask);
